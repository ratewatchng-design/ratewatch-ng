...
def main():
    ...
    job_queue.run_daily(send_daily_summary, time=asyncio.datetime.time(7, 0, tzinfo=tz))
    job_queue.run_daily(send_weekly_summary, time=asyncio.datetime.time(8, 0, tzinfo=tz),
                        days=(0,))  # Mondays
